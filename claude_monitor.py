...
def main():
    ...
    # Initialize CompactFormatter if needed
    ...
    try:
        ...
        if args.compact:
            ...
            # Compact mode: single-line display, translation respected
            while True:
                flush_input()
                data = analyze_usage()
                now = datetime.now(UTC_TZ)
                ...
                if end_time_str:
                    ...
                    reset_time = start_time + timedelta(hours=5)
                # Ensure reset_time and start_time are datetime objects
                ...
                if burn_rate > 0 and tokens_left > 0:
                    ...
                    predicted_end_time = reset_time
                # Ensure predicted_end_time is a datetime
